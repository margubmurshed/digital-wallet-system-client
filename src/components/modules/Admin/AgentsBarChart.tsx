...
export function AgentsBarChart() {
    ...
    const growthNumber = Number(stats?.growth.agents.split("%")[0])
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent>
                <ChartContainer config={chartConfig}>
                    <BarChart accessibilityLayer data={agentsData}>
                        ...
                        />
                        <Bar dataKey="agents" fill="var(--color-values)" radius={8} />
                    </BarChart>
                </ChartContainer>
            </CardContent>
            <CardFooter className="flex-col items-start gap-2 text-sm">
                ...
                <div className="text-muted-foreground leading-none">
                    {`Showing total agents for the last 7 days`}
                </div>
            </CardFooter>
        </Card>
    )
